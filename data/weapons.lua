...
for _, file in ipairs({
    'vanilla',
    'kyros_weapon_pack_v1',
    'kyros_weapon_pack_v2',
    'kyros_weapon_pack_v3',
    'kyros_weapon_pack_v4',
    'kyros_weapon_pack_v5',
    'kyros_weapon_pack_v6',
    'kyros_weapon_pack_airsoft',
    'kyros_weapon_pack_female',
    'kyros_weapon_pack_police',
}) do
    local item = require("data.weapons." .. file)
    for k, v in pairs(item) do
        if not weapons[k] then weapons[k] = v end
    end
end
		...
		['at_flashlight'] = {
			...
			client = {
				component = {
				    ...
				    `COMPONENT_AT_PI_PDT19_FLSH`, -- pd
					`COMPONENT_AT_AR_PDMK417_FLSH`,	-- pd
