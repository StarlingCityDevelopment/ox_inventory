shared.clothing = {
    male = {
        -- Drawables
        ["masks"] = { collection = "", drawable = 0, texture = 0 },
        ["torsos"] = { collection = "", drawable = 15, texture = 0 },
        ["legs"] = { collection = "mp_m_valentines_02", drawable = 1, texture = 1 },
        ["bags"] = { collection = "", drawable = 0, texture = 0 },
        ["shoes"] = { collection = "Male_Apt01", drawable = 1, texture = 0 },
        ["neck"] = { collection = "", drawable = 0, texture = 0 },
        ["shirts"] = { collection = "", drawable = 15, texture = 0 },
        ["vest"] = { collection = "", drawable = 0, texture = 0 },
        ...
        ["bracelets"] = { collection = nil, drawable = -1, texture = 0 },
    },
    female = {
        -- Drawables
        ["masks"] = { collection = "", drawable = 0, texture = 0 },
        ["torsos"] = { collection = "", drawable = 15, texture = 0 },
        ["legs"] = { collection = "", drawable = 15, texture = 0 },
        ["bags"] = { collection = "", drawable = 0, texture = 0 },
        ["shoes"] = { collection = "Female_Apt01", drawable = 1, texture = 0 },
        ["neck"] = { collection = "", drawable = 0, texture = 0 },
        ["shirts"] = { collection = "", drawable = 15, texture = 0 },
        ["vest"] = { collection = "", drawable = 0, texture = 0 },
        ["decals"] = { collection = "", drawable = 0, texture = 0 },
